                  ...
                  <div className="row">
                    ...
                    <div className="row custom-rows">
                        <div className="col-md-7">
                            <div className="grid">
                                <figure className="effect-layla">
                                    <img src={FindHroom[1].image} alt="lazz polli bangladesh" />
                                    <figcaption>
                        ...
                        <div className="col-md-5">
                            <div className="grid">
                                <figure className="effect-layla">
                                    <img src={FindHroom[2].image} alt="lazz polli cox's bazar" />
                                    <figcaption>
                    ...
                    <div className="row">
                       <div className="col-md-5x">
                            <div className="grid">
                                <figure className="effect-layla">
                                    <img src={FindHroom[3].image} alt="lazz polli resort bd best resort" />
                                    <figcaption>
                                        <h3 className='room-hide-border'>{FindHroom[3].topHeading} </h3>
