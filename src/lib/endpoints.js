...
//get fullpackage pool convention booked 
export const GET_FPC_BOOK_NOT_AVAIBLE = (Type,ArrivalDate,DepartureDate) => `BookingArea/Booking/placeType?Type=${Type}&ArrivalDate=${ArrivalDate}&DepartureDate=${DepartureDate}`
