        ...
        <div className="privacy-policy">
            <div className='container'>
              <div className="privacy-main">
                ...
                <span><b>Our cancellation policy is as follows:</b></span>
                <ul>
                ...
                <p className='pt-15'>
                <b>ADDITIONAL INFORMATION</b> Please note that all refunds will be issued in the same form as the original payment. Refunds may take 7 to 10 working days to process.
